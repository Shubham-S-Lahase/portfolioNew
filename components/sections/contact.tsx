...
import { CheckCircle2, Loader2, Mail, Send, Linkedin, Github } from "lucide-react";
...
export function Contact() {
  ...
  const onSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    // TODO: Hook this up to your real submission endpoint (Resend, EmailJS, an API route, etc.)
    ...
    <section id="contact" className="section">
      <div className="container-tight">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={viewport}
          className="mt-14 grid gap-6 lg:grid-cols-[1fr_1.2fr]"
        >
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-6 space-y-3">
                  <a
                    ...
                    className="group flex items-center gap-3 rounded-xl border border-border/60 bg-secondary/30 p-3 transition-colors hover:border-primary/60 hover:bg-secondary/60"
                  >
                  ...
                  >
                    ...
                    <span className="flex flex-col">
                      ...
                      <span className="text-sm font-medium">
                        {/* TODO: Replace with real GitHub handle */}
                        github.com/shubhamlahase
                      </span>
                    </span>
                  </a>
                </div>
