  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-border/70 bg-secondary/60 text-secondary-foreground hover:bg-secondary/80",
        outline:
          "border-border/70 text-foreground/90 hover:border-primary/60 hover:text-primary",
        accent:
